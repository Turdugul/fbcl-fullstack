...
export const metadata: Metadata = {
  title: 'Collections',
  description: 'Explore our extensive library collections including books, digital resources, and special collections at the Friern Barnet Community Library.',
}
...
const quickLinks = [
  {
    ...
    description: 'Search our complete collection of books, digital resources, and materials.',
    icon: Search,
